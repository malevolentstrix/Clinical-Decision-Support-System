...
def ocr_space_api(image_path, api_key):
    ...
    if response.status_code == 403:
        print("API limit reached or invalid API key. Waiting for 3700 seconds before retrying.")
        time.sleep(240)  # Wait for 3700 seconds (just over an hour)
        return ocr_space_api(image_path, api_key)
